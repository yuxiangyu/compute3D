...
def read_las(fname, attr_list=('rgb','class'),tm='EPSG:32650'):
	...
	#试一试
    attribute['rgb']=(attribute['rgb']/256).astype('u1')
    #print(attribute['rgb'])
   # print(arr['xyz'])
    # convert to dist
    pcd= {
...
if __name__ == "__main__":
   ...
   # src = 'E:\data\potree_converted\pointclouds\page3'
    # out dir
   # outdir = 'E:\data\potree_converted\pointclouds\potree'
    proj_param = 'EPSG:32650'
    convert23dtiles(src,outdir,proj_param)
    print("command has finished please press ctr+c!")
